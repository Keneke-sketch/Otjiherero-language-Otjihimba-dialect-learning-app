...
public class DaysQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.sunday);
        songs.add(1, R.raw.satur);
        songs.add(2, R.raw.fri);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(DaysQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DaysQuiz.this, DaysQuiz.class));
                finish();
