...
public class EmergencyQuiz extends AppCompatActivity {
    ...
    private answerclass[] questionBank = new answerclass[]
            {
                    ...
                    new answerclass(R.string.QuESTIOn3, R.string.QuESTIOn3B, R.string.QuESTIOn3B, R.string.QuESTIOn3C, R.string.QuESTIOn3D, R.string.AnSWeR3),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_quiz);

        ArrayList<Integer> songs = new ArrayList<>();
        songs.add(0, R.raw.help);
        songs.add(1, R.raw.please);
        songs.add(2, R.raw.wallet);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(EmergencyQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EmergencyQuiz.this, EmergencyQuiz.class));
                finish();
