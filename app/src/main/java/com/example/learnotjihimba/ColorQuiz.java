...
public class ColorQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.blue);
        songs.add(1, R.raw.red);
        songs.add(2, R.raw.pink);
//        songs.add(3, R.raw.beer);
//        songs.add(4, R.raw.banana);
//        songs.add(5, R.raw.arandis);
//        songs.add(6, R.raw.kananjab);
//        songs.add(7, R.raw.outjo);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(ColorQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ColorQuiz.this, ColorQuiz.class));
                finish();
