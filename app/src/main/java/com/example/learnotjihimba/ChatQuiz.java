...
public class ChatQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.visit);
        songs.add(1, R.raw.hungry);
        songs.add(2, R.raw.children);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(ChatQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ChatQuiz.this, ChatQuiz.class));
                finish();
