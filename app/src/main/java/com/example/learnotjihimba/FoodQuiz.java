...
public class FoodQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.meat);
        songs.add(1, R.raw.milk);
        songs.add(2, R.raw.bread);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(FoodQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(FoodQuiz.this, FoodQuiz.class));
                finish();
