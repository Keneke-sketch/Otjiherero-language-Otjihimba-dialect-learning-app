...
public class NumberQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.ndatu);
        songs.add(1, R.raw.imwe);
        songs.add(2, R.raw.ine);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(NumberQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NumberQuiz.this, NumberQuiz.class));
                finish();
