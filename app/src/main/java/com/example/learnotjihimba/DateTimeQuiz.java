...
public class DateTimeQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_time_quiz);

        ArrayList<Integer> songs = new ArrayList<>();
        songs.add(0, R.raw.days);
        songs.add(1, R.raw.year);
        songs.add(2, R.raw.month);
...
//        nxtButton = findViewById(R.id.nextBtn);
        ...
        dialog = new Dialog(DateTimeQuiz.this);
        ...
        buttonNo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DateTimeQuiz.this, DateTimeQuiz.class));
                finish();
